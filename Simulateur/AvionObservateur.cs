...
namespace Simulateur
{
    public class AvionObservateur : Vehicule //Véhicule de type Observateur
    {
         ...
         */
        public AvionObservateur(string p_nom, int p_KMH, int p_tempsMain, PosCarte p_posAeroport, Scenario p_scenario) //Constructeur
            : base(p_nom, p_KMH, p_tempsMain, Color.Gray, p_posAeroport, p_scenario)
        {
        }
