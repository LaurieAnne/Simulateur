...
namespace Simulateur
{
    ...
    {
        public Marchandise(Random p_rnd, Scenario p_scenario) : base(p_scenario) //Constructeur
        {
        ...
        public Marchandise(PosCarte p_PosDepart, PosCarte p_PosDestination, int p_nbClients, int p_PosX, int p_PosY, int p_PosXDest, int p_PosYDest, PosCarte p_posDest, Scenario p_scenario) : base(p_scenario) //Constructeur séparer
        {
            //Nombre de clients
        ...
        public Marchandise(Scenario p_scenario) : base(p_scenario)
        {
            //Le scénario actuel
            m_scenario = p_scenario;
        }
        ...
        public override ClientTransport separerClient(int nbClients)
        {
            ...
            return new Marchandise(this.Position, this.Destination, nbClients, this.m_PosX, this.m_PosY, this.m_PosXDest, this.m_PosYDest, this.m_posDest, this.m_scenario);
        }
